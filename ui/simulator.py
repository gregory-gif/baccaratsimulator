    ...
    with ui.column().classes('w-full max-w-4xl mx-auto gap-6 p-4'):
        ...
        with ui.card().classes('w-full bg-slate-900 p-6 gap-4'):
            ...
            with ui.row().classes('w-full gap-4 items-center'):
                ...
                slider_num_sims = ui.slider(min=10, max=100, value=20).props('color=white').classes('flex-grow')
                slider_years = ui.slider(min=1, max=10, value=5).props('color=blue').classes('flex-grow')
            ...
            with ui.row().classes('w-full gap-4 items-center'):
                ...
                slider_stop_loss = ui.slider(min=5, max=30, value=10).props('color=red').classes('flex-grow')
                slider_profit = ui.slider(min=3, max=20, value=10).props('color=green').classes('flex-grow')
            ...
            with ui.row().classes('w-full items-center justify-between'):
                with ui.column():
                    ...
                    slider_frequency = ui.slider(min=9, max=50, value=9).props('color=blue').classes('w-40 hidden')
